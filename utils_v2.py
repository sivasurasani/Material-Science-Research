...
import PyPDF2 # This line should appear only once at the top
import pytesseract
from pdf2image import convert_from_path
import nltk
from nltk.tokenize import word_tokenize
...
def find_max_size_chemical(text):
    ...
    element_dict = create_element_dictionary(max_size_chemical)  # Create a dictionary from the chemical formula
    return element_dict